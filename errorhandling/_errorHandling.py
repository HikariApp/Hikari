...
class NotBotOwnerError:
    def __repr__(self) -> str:
        return f"Sorry, you have no permissions to perform this command.\n-# <:eye_discord:1358721363707166870> This command is only permitted to bot owner, team owner, team admins & developers • [Learn more](<https://discord.com/developers/docs/topics/teams#team-member-roles>)"
